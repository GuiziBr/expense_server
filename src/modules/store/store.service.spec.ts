...
describe("StoreService", () => {
	...
	describe("getById", () => {
		it("should throw Internal server error exception", async () => {
			...
			expect(loggerSpy).toBeCalledWith(
				"Error - Error - getting store by id store-id"
			)
		})
	...
	describe("create", () => {
		it("should throw Internal server error exception", async () => {
			...
			expect(loggerSpy).toBeCalledWith(`Error - Error - creating store ${name}`)
		})
	...
	describe("update", () => {
		...
		it("should return updated store", async () => {
			const result = await storeService.update(fakeStore.id, "updated-store")
		...
		it("should throw Store already exists exception", async () => {
			await expect(
				storeService.update("store-id", "updated-store")
			).rejects.toThrow("There is already a store with same name")
			...
			expect(loggerSpy).toBeCalledWith(
				'Store with name "updated-store" already exists'
			)
		})
