...
describe("CategoryService", () => {
	...
	describe("getAll", () => {
		it("should throw Internal server error exception", async () => {
			vi.spyOn(databaseService.category, "findMany").mockRejectedValue(
				new Error()
			)
	...
	describe("getById", () => {
		it("should throw Internal server error exception", async () => {
			...
			expect(loggerSpy).toBeCalledWith(
				"Error - Error - getting category by id category-id"
			)
		})
	...
	describe("create", () => {
		it("should throw Internal server error exception", async () => {
			vi.spyOn(databaseService.category, "upsert").mockRejectedValue(
				new Error()
			)
			...
			expect(loggerSpy).toBeCalledWith(
				`Error - Error - creating category ${description}`
			)
		})
	...
	describe("update", () => {
		...
		it("should throw category already exists exception", async () => {
			...
			expect(loggerSpy).toBeCalledWith(
				'Category with description "updated-category" already exists'
			)
		})
